<template>
  <footer
   ...
   <!-- {# <router-link
    ...
    <router-link
      to="/exercices"
      class=" flex shadow-neutral-600 shadow-lg p-3 rounded-2xl nav-btn nav-btn--green w-20 h-16  font-bold hover:underline flex-col items-center justify-center transition-colors duration-200"
    >
