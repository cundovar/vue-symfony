 ...
 */
final class Version20251128220602 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appy_PageVisit ADD CONSTRAINT FK_AF0167AAC4663E4 FOREIGN KEY (page_id) REFERENCES appy_Page (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE appy_PageVisit ADD CONSTRAINT FK_AF0167AAA76ED395 FOREIGN KEY (user_id) REFERENCES appy_User (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
    }
}
